...
@cache_kernel
def _efc_contact_count(cone_type: types.ConeType, is_sparse: bool, flg_adhesion: bool):
  ...
  def kernel(
    ...
    # must match _efc_contact_init's activity rule, or the row counts disagree with the rows written
...
@cache_kernel
def _efc_contact_count_flex(cone_type: types.ConeType, is_sparse: bool, flg_adhesion: bool):
  IS_ELLIPTIC = cone_type == types.ConeType.ELLIPTIC
  IS_SPARSE = is_sparse
...
@cache_kernel
def _efc_contact_init(cone_type: types.ConeType, is_sparse: bool, deterministic: bool, newton: bool, flg_adhesion: bool):
  IS_ELLIPTIC = cone_type == types.ConeType.ELLIPTIC
  IS_SPARSE = is_sparse
...
@cache_kernel
def _efc_contact_init_flex(cone_type: types.ConeType, is_sparse: bool, deterministic: bool, newton: bool, flg_adhesion: bool):
  IS_ELLIPTIC = cone_type == types.ConeType.ELLIPTIC
  IS_SPARSE = is_sparse
  ...
  if not (m.opt.disableflags & types.DisableBit.CONSTRAINT):
    ...
    if not (m.opt.disableflags & types.DisableBit.CONTACT):
      ...
      if det:
        ...
        if has_flex:
          wp.launch(
            _efc_contact_count_flex(m.opt.cone, m.is_sparse, m.flg_adhesion),
            dim=d.naconmax,
            inputs=[
              m.body_weldid,
              m.body_dofnum,
          ...
          wp.launch(
            _efc_contact_count(m.opt.cone, m.is_sparse, m.flg_adhesion),
            dim=d.naconmax,
            inputs=[
              m.body_weldid,
              m.body_dofnum,
      ...
      if has_flex:
        wp.launch(
          _efc_contact_init_flex(m.opt.cone, m.is_sparse, det, newton, m.flg_adhesion),
          dim=d.naconmax,
          inputs=[
            m.body_parentid,
            m.body_weldid,
        ...
        wp.launch(
          _efc_contact_init(m.opt.cone, m.is_sparse, det, newton, m.flg_adhesion),
          dim=d.naconmax,
          inputs=[
            m.body_weldid,
            m.body_dofnum,
